...
To support specialized rendering for web pages and different page layouts, Your `template.typ` can import and respect the `page-width` and `target` variable from `@preview/shiroa:0.2.1` to this time.

```typ
#import "@preview/shiroa:0.2.1": page-width, target
