  ...
  summary: [
    ...
    - #chapter("format/main.typ")[Format]
      ...
      - #chapter("supports.typ")[Typst Support]
        - #chapter("supports/package.typ")[Package API]
        - #chapter("supports/book-description.typ")[Book Description]
        - #chapter("supports/targets.typ")[Rendering Targets and Inputs]
        - #chapter("supports/metadata.typ")[Reading Metadata]
        - #chapter("supports/content.typ")[Content Helpers]
        - #chapter("supports/cross-ref.typ")[Cross Reference]
          - #chapter("supports/cross-ref-sample.typ")[Cross Reference Sample]
        - #chapter("supports/embed-html.typ")[Embed Sanitized HTML Elements]
          - #chapter("supports/multimedia.typ")[Multimedia components]
        - #chapter("supports/render-test.typ")[Rendering Tests]
        - #chapter("supports/theme.typ")[Theme]
...
#import "/contrib/typst/gh-pages.typ": heading-reference, project
